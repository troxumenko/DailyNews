...
public class SportNewsView extends BaseView {
    ...
    public SportNewsView(@NonNull Context context) {
        this(context, null);
    }

    public SportNewsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SportNewsView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void loadJSON() {
        ...
        isLoading = true;
        subscriptions.add(
                apiService.getArticlesNews("ua", "sport", page, 5)
