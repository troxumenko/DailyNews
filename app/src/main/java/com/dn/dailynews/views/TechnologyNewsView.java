...
public class TechnologyNewsView extends BaseView {
    ...
    public TechnologyNewsView(@NonNull Context context) {
        this(context, null);
    }

    public TechnologyNewsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TechnologyNewsView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void loadJSON() {
        ...
        isLoading = true;
        subscriptions.add(
                apiService.getArticlesNews("ua", "technology", page, 5)
